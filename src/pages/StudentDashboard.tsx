...
import { 
  BookOpen, Trophy, BarChart3, Settings, Play, Lock, CheckCircle2, 
  Clock, Target, Zap, Star, Crown, ArrowRight 
} from "lucide-react";
...
const StudentDashboard = () => {
  ...
  const { profile, isPremium } = useStudent();
  ...
  const totalTime = progress.tests.reduce((s, t) => s + (t.timeSpent || t.duration || 0), 0);
          ...
          <div className="max-w-5xl mx-auto space-y-6">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-2">
                {!isPremium && (
                  <Button variant="default" className="gap-1.5 bg-gradient-to-r from-yellow-500 to-orange-500 hover:from-yellow-600 hover:to-orange-600" onClick={() => navigate('/pricing')}>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <Card className="border-border">
                <CardContent className="pt-4 pb-4 text-center">
                  ...
                  <p className="text-2xl font-bold text-foreground">{avgWpm}</p>
              ...
              <Card className="border-border">
                <CardContent className="pt-4 pb-4 text-center">
                  ...
                  <p className="text-2xl font-bold text-foreground">{avgAcc}%</p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              {nextLesson && (
                <Button className="h-auto py-4 flex-col gap-2" onClick={() => navigate(`/lesson/${nextLesson.id}`)}>
              ...
              <Card className="border-yellow-500/30 bg-gradient-to-r from-yellow-500/5 to-orange-500/5">
                <CardContent className="pt-6 pb-6 text-center">
                  ...
                  <p className="text-muted-foreground mb-4">
                    Free plan includes {FREE_LESSON_COUNT} lessons. Upgrade to Premium to access all chapters, speed tests, and get your typing certificate.
                  </p>
                  <Button className="bg-gradient-to-r from-yellow-500 to-orange-500 hover:from-yellow-600 hover:to-orange-600" onClick={() => navigate('/pricing')}>
